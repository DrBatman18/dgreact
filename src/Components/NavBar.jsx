        ...
        <div className="col-md-8">
          <nav className="navbar navbar-expand-lg">
            <div className="container-fluid">
              <Link className="navbar-brand" to={"/"}><img src="images/logo.png" alt="Encontralo ONLINE" width="108" /> Menu </Link>
              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item"><NavLink className="nav-link"activeclassname="page"  to={"category/servicios"}>Servicios</NavLink>
                  </li>
